...
insert into public.usuarios (id, nombre, email, alcance, cargo, activo, "creadoEn") values
  ('u_matias', 'Matías Harvey', 'matias@harveywillys.com',  'usuario','Socio · Operaciones',           true, now() - interval '120 days'),
  ('u_tomas',  'Tomás Harvey',  'tomas@harveywillys.com',   'usuario','Socio · Producto y diseño',     true, now() - interval '120 days'),
  ('u_nico',   'Nicolás Harvey','nicolas@harveywillys.com', 'usuario','Socio · Comercial y retail',    true, now() - interval '120 days'),
  ('u_lucas',  'Lucas Harvey',  'lucas@harveywillys.com',   'usuario','Socio · Marketing y comunidad', true, now() - interval '120 days'),
...
insert into public.salas
  (id, nombre, descripcion, cadencia, "horasCierreAgenda", "cierreManual",
   "duracionReunionDefaultMin", "duracionTemaDefaultMin", "lugarHabitual", "creadaPor", "creadaEn", archivada)
values
  ('sala_gerencial','Socios','La reunión semanal de los cuatro. Acá están todos a la par.',
   'Lunes 10:00', 24, false, 60, 15, 'Showroom Palermo', 'u_matias', now() - interval '130 days', false),
  ('sala_diseno','Diseño','Tomás con el equipo de producto y moldería.',
   'Miércoles 15:00', 12, false, 45, 15, 'Taller', 'u_tomas', now() - interval '60 days', false),
  ('sala_marketing','Marketing','Lucas con el equipo de contenido y comunidad.',
   'Jueves 11:00', 24, true, 45, 10, null, 'u_lucas', now() - interval '45 days', false);
...
insert into public.reuniones
  (id, "salaId", titulo, fecha, "duracionPrevistaMin", lugar, "moderadorId", "participantesIds",
   estado, "horasCierreAgenda", "cierreManual", "conclusionesGenerales", observaciones,
...
select * from (
  ...
  select
    ...
    'u_matias', array['u_matias','u_tomas','u_nico','u_lucas'],
    'agenda_cerrada', 24, false, null, null,
  ...
  select
    ...
    'u_matias', array['u_matias','u_tomas','u_nico','u_lucas'],
    'agenda_abierta', 24, false, null, null,
    f.lunes_prox2, null, null, null,
    'u_matias', now() - interval '2 days'
  from t_fechas f
  union all
  select
    'r_s16', 'sala_gerencial', 'Reunión semanal de socios · #16', f.lunes_prox2, 60, 'Showroom Palermo',
    'u_matias', array['u_matias','u_tomas','u_nico','u_lucas'],
    'borrador', 24, false, null, null,
    null, null, null, null,
  ...
  select
    ...
    'agenda_abierta', 12, false, null, null,
    null, null, null, null,
...
values
  ...
  ('t_8','sala_gerencial','r_s14','Repaso de compromisos abiertos','Bloque fijo al inicio: se abre el tablero y se repasa lo que quedó de antes.','media','informativa','u_matias',10,null,'aprobado',1,null,null, now() - interval '5 days'),
  ...
  ('t_11','sala_gerencial','r_s14','Rediseño del packaging','Tomás trajo tres opciones de bolsa.','baja','exploratoria','u_tomas',10,null,'diferido',4,null,'No entra en los 60 minutos. Pasa a la próxima.', now() - interval '4 days'),
  ...
  ('t_14','sala_gerencial','r_s15','Rediseño del packaging','Viene diferido de la #14. Tres opciones de bolsa para elegir.','baja','decision','u_tomas',10,null,'propuesto',2,null,null, now() - interval '1 day'),
  ...
  -- Banco de la sala de socios: lo que Fran llamó "banco de suplentes"
  ('t_b1','sala_gerencial',null,'Revisar el seguro del showroom','Vence en octubre y nunca lo comparamos con otras aseguradoras.','baja','informativa','u_nico',10,null,'banco',0,null,null, now() - interval '9 days'),
  ('t_b2','sala_gerencial',null,'Sistema de talles: sumar XXL','Nos lo piden mucho por Instagram. Impacta en moldería y en costos de tela.','media','exploratoria','u_lucas',15,null,'banco',0,null,null, now() - interval '6 days'),
  ('t_b3','sala_gerencial',null,'Vacaciones de enero: quién cubre qué',null,'media','decision','u_matias',15,null,'banco',0,null,null, now() - interval '2 days'),
  ...
  ('t_d3','sala_diseno',null,'Probar el proveedor de avíos nuevo','Mandaron muestras de cierres y botones. Verlas antes de la próxima temporada.','baja','exploratoria','u_renata',10,null,'banco',0,null,null, now() - interval '4 days'),
...
values
  ...
  ('c_4','sala_gerencial','r_s12','t_3','Armar el calendario de contenido del drop cápsula',null,'u_lucas', now() - interval '9 days','media','bloqueado','Frenado hasta tener las fotos del shooting. El fotógrafo reprogramó dos veces.',null, now() - interval '25 days'),
  ...
  ('c_m3','sala_marketing','r_m01','t_m2','Confirmar fecha nueva con el fotógrafo',null,'u_lucas', now() - interval '2 days','alta','bloqueado','No contesta desde el martes.',null, now() - interval '4 days');
